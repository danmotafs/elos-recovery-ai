...
const roadmap = [
  {
    ...
    items: [
      ...
      "Gerador Automático de Recursos",
      "Dashboard Executivo",
    ],
  },
  {
    icon: ScanLine,
    phase: "Próxima Evolução",
    title: "OCR Real para Documentos",
    items: [
      "Leitura automática de PDFs",
      "Extração de informações clínicas",
      "Indexação documental inteligente",
      "Pré-preenchimento assistido",
    ],
  },
  {
    icon: Database,
    phase: "Integrações Regulatórias",
    title: "TUSS, CBHPM e ANS",
    items: [
      "Integração TUSS",
      "Integração CBHPM",
      "Normativas ANS",
      "Regras contratuais por convênio",
    ],
  },
  {
    icon: BrainCircuit,
    phase: "Inteligência Analítica",
    title: "Machine Learning",
    items: [
      "Predição de recuperação",
      "Detecção de padrões de glosa",
      "Benchmark entre operadoras",
      "Priorização por valor recuperável",
    ],
  },
  {
    icon: Building2,
    phase: "Integrações Hospitalares",
    title: "Ecossistema Hospitalar",
    items: [
      "ERP Hospitalar",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section id="roadmap" className="mx-auto max-w-7xl px-6 py-24">
        <div className="mb-12 max-w-4xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-tight md:text-5xl">
            Roadmap Evolutivo da Plataforma.
          </h2>
          <p className="mt-6 text-lg leading-8 text-slate-300">
            A ELOS está construindo uma plataforma inteligente para recuperação
            de receitas hospitalares, combinando expertise humana, automação e
              ...
              >
                ...
                <div className="mt-5 space-y-3">
                  {item.items.map((roadmapItem) => (
                    <div key={roadmapItem} className="flex gap-2">
