      ...
      <section className="border-t border-white/10 bg-slate-900/40 py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 text-center">
            <h2 className="text-4xl font-semibold">Roadmap Evolutivo da Plataforma</h2>
            <p className="mt-4 text-slate-300 max-w-3xl mx-auto">
              A ELOS está construindo uma plataforma inteligente para recuperação de receitas hospitalares,
              combinando expertise humana, automação e inteligência artificial aplicada à saúde.
            </p>
          </div>

          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-5">
            <div className="rounded-3xl border border-emerald-500/30 bg-slate-950 p-6">
              <h3 className="mb-4 text-xl font-semibold text-emerald-400">Fase Atual</h3>
              <ul className="space-y-2 text-sm text-slate-300">
                <li>✓ Análise Inteligente de Glosas</li>
                <li>✓ Base de Conhecimento Especializada</li>
                <li>✓ Radar do Especialista</li>
                <li>✓ Gerador Automático de Recursos</li>
                <li>✓ Dashboard Executivo</li>
              </ul>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-950 p-6">
              <h3 className="mb-4 text-xl font-semibold">OCR Real</h3>
              <ul className="space-y-2 text-sm text-slate-300">
                <li>Leitura automática de PDFs</li>
                <li>Extração de informações clínicas</li>
                <li>Indexação documental inteligente</li>
                <li>Processamento de anexos hospitalares</li>
              </ul>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-950 p-6">
              <h3 className="mb-4 text-xl font-semibold">TUSS • CBHPM • ANS</h3>
              <ul className="space-y-2 text-sm text-slate-300">
                <li>Integração TUSS</li>
                <li>Integração CBHPM</li>
                <li>Normativas ANS</li>
                <li>Regras contratuais por convênio</li>
              </ul>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-950 p-6">
              <h3 className="mb-4 text-xl font-semibold">Machine Learning</h3>
              <ul className="space-y-2 text-sm text-slate-300">
                <li>Predição de recuperação</li>
                <li>Detecção de padrões de glosa</li>
                <li>Benchmark entre operadoras</li>
                <li>Aprendizado contínuo</li>
              </ul>
            </div>

            <div className="rounded-3xl border border-white/10 bg-slate-950 p-6">
              <h3 className="mb-4 text-xl font-semibold">Integrações Hospitalares</h3>
              <ul className="space-y-2 text-sm text-slate-300">
                <li>ERP Hospitalar</li>
                <li>Prontuário Eletrônico</li>
                <li>Faturamento</li>
                <li>Business Intelligence Corporativo</li>
              </ul>
            </div>
          </div>
        </div>
